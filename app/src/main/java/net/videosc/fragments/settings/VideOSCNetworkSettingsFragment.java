...
public class VideOSCNetworkSettingsFragment extends VideOSCBaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        udpReceivePortField.setOnFocusChangeListener((v, b) -> {
        ...
        tcpReceivePortField.setOnFocusChangeListener((v, hasFocus) -> {
        ...
        rootCmdField.setOnFocusChangeListener((v, b) -> {
        ...
        tcpPasswdField.setOnFocusChangeListener((v, hasFocus) -> {
