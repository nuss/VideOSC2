...
public class OscMessage extends OscPacket {
    private final static String TAG = OscMessage.class.getSimpleName();
    ...
    public OscMessage(final OscMessage theOscMessage) {
        ...
        isPlugged = theOscMessage.isPlugged;
        isValid = true;
    }
    ...
    protected Object[] increase() {
        if (_myArguments.length < 1) {
            return new Object[1];
        }
        Object[] myArguments = new Object[_myArguments.length + 1];
